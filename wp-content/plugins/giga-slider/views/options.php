<div class="form-group">
    ...
    <span class="note" style="color:#F00; padding:2px"><?php _e('Default : 50% to be responsive ', 'rc_slider') ?></span>
</div>

<div class="form-group">
	<label class="label"><?php _e('Time', 'rc_slider') ?></label>
	<label class="label value" id="time_value"><?php echo esc_attr($time) ?> sec</label>
	<div class="rc-slider" style="width:240px" id="time_slider"></div>
...
<div class="form-group">
	...
	<div class="rc-slider" style="width:240px" id="transition_period_slider"></div>
...
<div class="form-group">
	<label class="label" for="thumbnail_size"><?php _e('Thumbnail size', 'rc_slider') ?></label></th>
...
<div class="form-group">
	<label class="label" for="bar_position"><?php _e('Bar position', 'rc_slider') ?></label></th>
...
<div class="form-group">
	<label class="label" for="bar_direction"><?php _e('Bar direction', 'rc_slider') ?></label></th>
...
<div class="form-group last">
	<label class="label" for="watermark_alignment"><?php _e('Watermark alignment', 'rc_slider') ?></label></th>
	<select class="widefat" name="options[watermark_alignment]" id="watermark_alignment">
		<option value="topRight" <?php selected($watermark_alignment, 'topRight') ?>><?php _e('Top right', 'rc_slider') ?></option>
		<option value="bottomRight" <?php selected($watermark_alignment, 'bottomRight') ?>><?php _e('Bottom right', 'rc_slider') ?></option>
		<option value="center" <?php selected($watermark_alignment, 'center') ?>><?php _e('Center', 'rc_slider') ?></option>
		<option value="bottomLeft" <?php selected($watermark_alignment, 'bottomLeft') ?>><?php _e('Bottom left', 'rc_slider') ?></option>
		<option value="topLeft" <?php selected($watermark_alignment, 'topLeft') ?>><?php _e('Top left', 'rc_slider') ?></option>
	</select>
</div>
