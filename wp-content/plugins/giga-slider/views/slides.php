				...
				id="image_container_<?php echo $i ?>">
					<div class="form_container">
						...
						<div class="form-group lastSlide">
							...
							<select class="widefat slides_style_template" id="slides_style_template_<?php echo $i ?>">
					...
					<div class="image_container">
                        ...
                        <span class="note" style="color:#F00"><?php _e('Best image size is 1280*850 px', 'rc_slider') ?></span>
